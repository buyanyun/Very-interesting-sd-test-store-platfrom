  ...
  <div class="container">
    ...
    <div id="logbox">
      <form id="signup" method="POST" action="oncar_login_page.php">
        ...
        <input name="driverID" type="text" placeholder="Be a Test Driver?" class="input pass"/>
        <input name="phonenumber" type="text" placeholder="Phone number!" class="input pass"/>
...
if ($db_conn) {
  if (array_key_exists('addaccount', $_POST)) {
    ...
    echo htmlentities('The account number is:');
    echo htmlentities($accountNo);
